...
use Lagdo\UiBuilder\Bootstrap4\Element\CheckboxElement;
use Lagdo\UiBuilder\Bootstrap3\Element\FormElement;
use Lagdo\UiBuilder\Bootstrap4\Element\InputGroupElement;
use Lagdo\UiBuilder\Bootstrap4\Element\OptionElement;
use Lagdo\UiBuilder\Bootstrap4\Element\RadioElement;
...
trait FormTrait
{
    ...
    protected function createFormElement(string $tagName, $arguments): ElementInterface
    {
        ...
        $element->prependClass($tagName === 'label' ? 'col-form-label' : 'form-control');
        return $element;
    }
}
